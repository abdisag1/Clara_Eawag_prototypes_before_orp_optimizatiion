...
static byte pinA4=  A4;
static byte pinA5=  A5;
...
Wata wata_used(pin10,pin11);

Levelsensors level_sensors_used(pinA0,pinA1,pinA2);

Voltagesensor voltage_sensorused(pinA3);
Orpsensors orp_sensorused(pinA4,pinA5);
